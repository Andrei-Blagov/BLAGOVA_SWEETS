...
const slides: Slide[] = [
    {
        ...
        text:
            'Готовим тесто сами на сливочном масле и куриных яйцах, без готовых смесей и искусственных усилителей вкуса. В составе: мука высшего сорта, сахар, масло сливочное, яйцо, корица, имбирь, сода, питьевая вода и кондитерская глазурь.',
        bullets: [
    ...
    },
    {
        ...
        text:
            'Мы не используем мёд и делаем рецепт максимально деликатным, чтобы пряники подходили даже тем детям, у кого есть склонность к аллергии.',
        bullets: [
            'без содержания мёда',
