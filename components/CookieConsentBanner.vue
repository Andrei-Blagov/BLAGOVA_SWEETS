<template>
    <Teleport to="body">
        <div v-if="visible" class="fixed inset-x-0 bottom-0 z-[9998] px-4 pb-4 sm:px-6 sm:pb-6 pointer-events-none">
            <div class="pointer-events-auto max-w-6xl mx-auto
...
const hide = () => {
    // просто уберём баннер, формально текст уже говорит, что продолжая пользование — согласие
