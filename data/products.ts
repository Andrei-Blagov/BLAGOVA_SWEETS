...
export const products: Product[] = [
    ...
    },
    {
        ...
        name: 'Пряник для мамы Сердце',
        description: 'Элегантный сладкий подарок в виде сердца — идеальное выражение любви и заботы!',
        price: 277,
        category: 'gingerbread',
    ...
    },
    {
        ...
        name: 'Пряник для мамы Зайчик',
        description: 'Фигурный имбирный пряник (11*11 см) - оригинальный и вкусный подарок для любого случая!',
        price: 307,
        category: 'gingerbread',
    ...
    },
    {
        ...
        name: 'Пряники топеры для торта для мальчика на 14 лет',
        description: 'Пряники-топперы «На 14 лет» для мальчика от BLAGOVA SWEETS – идеальное дополнение для юбилейного торта!',
        price: 307,
        category: 'gingerbread',
    ...
    },
    {
        ...
        name: 'Пряники топеры для торта для девочки на День рождения',
        description: 'Пряники-топперы для девочки на День Рождения от «BLAGOVA SWEETS» – идеальное украшение для детского праздника!',
        price: 307,
        category: 'gingerbread',
    ...
    },
    {
        ...
        name: 'Пряники на торт Девушке',
        description: 'Пряники на торт Девушке – традиционный сладкий подарок с душой.',
        price: 307,
        category: 'gingerbread',
    ...
    },
    {
        ...
        name: 'Пряники на новый год "С Новым годом" Новогодние шары',
        description: 'Пряники «С Новым годом» — это ручная авторская работа, выполненная в виде праздничных шаров.',
        price: 307,
        category: 'gingerbread',
    ...
    },
    {
        ...
        name: 'Пряники топеры для торта для девочки Единорожка',
        description: 'Пряники-топеры «Единорожка» от Blagova Sweets – идеальное украшение праздничного торта для юной принцессы!',
        price: 307,
        category: 'gingerbread',
    ...
    },
    {
        ...
        name: 'Пряник на новый год "С Новым годом" с Символом Года',
        description: 'Пряники «С Новым годом» Мандаринки – идеальное сочетание традиций и заботы!',
        price: 307,
        category: 'gingerbread',
    ...
    {
        id: 16,
        slug: 'gingerbread-owl-boy',
        name: 'Пряники для мальчика Совушка',
        description: 'Пряник для мальчика "Совушка": сладкий выбор для активных!',
        price: 307,
        category: 'gingerbread',
        mainImage: '/photos_of_products/gingerbread-owl-boy.webp',
        images: ['/photos_of_products/gingerbread-owl-boy.webp', '/photos_of_products/gingerbread-owl-boy_2.webp'],
        isPopular: true,
        outOfStock: false
    },
    {
        id: 17,
        slug: 'gingerbread-owl-girl',
        name: 'Пряники для девочки Совушка',
        description: 'Пряник для девочки Совушка – сладкий подарок с душой.',
        price: 307,
        category: 'gingerbread',
        mainImage: '/photos_of_products/gingerbread-owl-girl.webp',
        images: ['/photos_of_products/gingerbread-owl-girl.webp', '/photos_of_products/gingerbread-owl-girl_2.webp'],
        isPopular: true,
        outOfStock: false
    },
    {
        id: 18,
        slug: 'gingerbread-girlfriend-present',
        name: 'Пряники подруге',
        description: 'Пряник подруге – Набор для девушки С Днем Рождения.',
        price: 307,
        category: 'gingerbread',
        mainImage: '/photos_of_products/gingerbread-girlfriend-present.webp',
        images: ['/photos_of_products/gingerbread-girlfriend-present.webp', '/photos_of_products/gingerbread-girlfriend-present_2.webp'],
        isPopular: true,
        outOfStock: false
    },
    // {
    ...
    },
    {
        ...
        description: 'Песочная основа, нежная ванильная начинка. Нужен предзаказ.',
        price: 1500,
        category: 'cake',
