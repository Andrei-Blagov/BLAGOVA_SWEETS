...
const tabs = [{ id: 'orders', name: 'Заказы', icon: 'bag' }, { id: 'conversations', name: 'Диалоги', icon: 'heart' }, { id: 'calendar', name: 'Календарь', icon: 'clock' }, { id: 'catalog', name: 'Каталог', icon: 'gift' }, { id: 'knowledge', name: 'Знания', icon: 'leaf' }, { id: 'integrations', name: 'Подключения', icon: 'diagonal' }];
